...
import type { Article, InteractionType } from '../types';
...
export default function Dashboard() {
  ...
  const sendInteraction = useCallback(async (articleId: string, type: InteractionType) => {
  ...
  return (
    <div style={styles.container}>
      ...
      <div>
        {articles.map((a) => (
          <article key={a.id} style={styles.article}>
            ...
            <div style={styles.article_buttons}>
